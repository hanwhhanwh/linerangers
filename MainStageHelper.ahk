;===============================================================================
; @file MainStageHelper.ahk
; @author hbesthee@naver.com
; @date 2022-03-13
;
; @description MainStage Ranger 출격 도우미 스크립트
;
;===============================================================================
...
g_nTermOfChangeTeam := 4500 ; 팀 변경 시간
...
AppendLogWIndow( "Start [MainStage Helper] Script : Client Hwnd = " . g_hwndAppPlayerClient . " Client X = " . g_nClientX . " | Client Y = " . g_nClientY )
