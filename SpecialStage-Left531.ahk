...
AppendLogWIndow( "Start SpecialStage Left531 Script : Client Hwnd = " . g_hwndAppPlayerClient . " Client X = " . g_nClientX . " | Client Y = " . g_nClientY )
...
g_arrStages := [ [358, 183, 5], [190, 120, 3], [132, 267, 1] ]
...
AppendLogWIndow( "#" . nStage . ") Special Stage(Left531) 로의 진입......" )
