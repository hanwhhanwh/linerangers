;===============================================================================
; @file SpecialStage-Elemental.ahk
; @author hbesthee@naver.com
; @date 2020-06-26
;
; @description SPECIAL STAGE : Three Elemental stages를 위한 통합 스크립트
;
;===============================================================================
...
AppendLogWIndow( "Start SpecialStage Elemental Script : Client Hwnd = " . g_hwndAppPlayerClient . " Client X = " . g_nClientX . " | Client Y = " . g_nClientY )
...
AppendLogWIndow( "#" . nStage . ") Special Stage(Elemental) 로의 진입......" )
